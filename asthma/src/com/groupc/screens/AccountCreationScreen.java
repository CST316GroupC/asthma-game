...
public class AccountCreationScreen extends Screen
{
	...
	int     type       = 1;
	boolean played 	   = true;
	private String newPatientDoctor = run.getUserName();
	...
	public void addCurrentPatient() 
	{
		...
		{
			Database.addPatient(firstNameTF.getText(), lastNameTF.getText(), monthTF.getText(), dayTF.getText(), yearTF.getText(), passwordTF.getText(), emailTF.getText(), infoTA.getText());

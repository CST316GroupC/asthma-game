...
public class TextureRegion 
{
	...
	{	
		...
		//topleft
		points[0] = new Vector((x/textWidth), 1 - ((y+height)/textHeight));
		//topright
		points[1] = new Vector(((x+width)/textWidth), 1 - (y+height/textHeight));
		//botright
		points[2] = new Vector(((x+width)/textWidth), 1 - (y/textHeight));
		//botleft
		points[3] = new Vector((x/textWidth), 1 - (y/textHeight));	
	}
